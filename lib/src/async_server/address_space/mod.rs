...
macro_rules! node_builder_impl {
    ( $node_builder_ty:ident, $node_ty:ident ) => {
        use $crate::async_server::address_space::{
            address_space::AddressSpace, ReferenceDirection,
        };
...
macro_rules! node_base_impl {
    ( $node_struct:ident ) => {
        use crate::async_server::address_space::NodeType;
        ...
        impl crate::async_server::address_space::NodeBase for $node_struct {
