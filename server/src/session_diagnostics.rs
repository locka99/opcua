...
impl SessionDiagnostics {
    ...
    pub(crate) fn register_session(
        ...
        let _builder = ObjectBuilder::new(
            session_id,
            format!("{}", session_id),
            format!("{}", session_id),
        )
    ...
    pub(crate) fn deregister_session(
        &self,
        session: &Session,
        address_space: &mut AddressSpace,
    ) {
...
pub(crate) const CREATE_MONITORED_ITEMS_COUNT: &'static str =
    "CreateMonitoredItemsCount";
pub(crate) const MODIFY_MONITORED_ITEMS_COUNT: &'static str =
...
pub(crate) const DELETE_MONITORED_ITEMS_COUNT: &'static str =
...
pub(crate) const TRANSFER_SUBSCRIPTIONS_COUNT: &'static str =
