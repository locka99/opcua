...
fn add_sample_vars_to_address_space(address_space: &mut AddressSpace) {
    ...
    let vars = vec![
        Variable::new(&NodeId::new_string(1, "v1"), "v1", "v1", "", 30 as Int32),
        Variable::new(&NodeId::new_numeric(2, 300), "v2", "v2", "", true),
        Variable::new(&NodeId::new_string(1, "v3"), "v3", "v3", "", UAString::from_str("Hello world"))
    ];
