...
#[test]
fn variant_type_id() {
    use crate::{UAString, DateTime, ByteString, XmlElement, NodeId, ExpandedNodeId, QualifiedName, LocalizedText, ExtensionObject, Guid};
...
fn ensure_conversion_fails(v: &Variant, convert_to: &[VariantTypeId]) {
    convert_to.iter().for_each(|vt| assert_eq!(v.convert(*vt), Variant::Empty));
}
...
fn variant_convert_bool() {
    ...
    ensure_conversion_fails(&v, &[
        VariantTypeId::ByteString, VariantTypeId::String, VariantTypeId::DateTime,
        VariantTypeId::ExpandedNodeId, VariantTypeId::Guid, VariantTypeId::NodeId,
        VariantTypeId::StatusCode, VariantTypeId::LocalizedText, VariantTypeId::QualifiedName,
...
fn variant_cast_bool() {
    // String
    assert_eq!(Variant::from(false).cast(VariantTypeId::String), Variant::from("false"));
    assert_eq!(Variant::from(true).cast(VariantTypeId::String), Variant::from("true"));
}
...
fn variant_convert_byte() {
    ...
    // Impermissible
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::String, VariantTypeId::ByteString,
        VariantTypeId::DateTime, VariantTypeId::ExpandedNodeId, VariantTypeId::Guid,
        VariantTypeId::NodeId, VariantTypeId::StatusCode, VariantTypeId::LocalizedText,
        VariantTypeId::QualifiedName, VariantTypeId::XmlElement
    ]);
}
...
fn variant_cast_byte() {
    let v: Variant = 5u8.into();
    // Boolean
    assert_eq!(Variant::from(11u8).cast(VariantTypeId::Boolean), Variant::Empty);
    assert_eq!(Variant::from(1u8).cast(VariantTypeId::Boolean), Variant::from(true));
    // String
...
fn variant_convert_double() {
    ...
    // Impermissible
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::Byte, VariantTypeId::ByteString,
        VariantTypeId::DateTime, VariantTypeId::ExpandedNodeId, VariantTypeId::Float,
        VariantTypeId::Guid, VariantTypeId::Int16, VariantTypeId::Int32, VariantTypeId::Int64,
        VariantTypeId::NodeId, VariantTypeId::SByte, VariantTypeId::StatusCode, VariantTypeId::String,
        VariantTypeId::LocalizedText, VariantTypeId::QualifiedName, VariantTypeId::UInt16,
        VariantTypeId::UInt32, VariantTypeId::UInt64, VariantTypeId::XmlElement
    ]);
}
...
fn variant_cast_double() {
    let v: Variant = 12.5f64.into();
    // Cast Boolean
    assert_eq!(Variant::from(11f64).cast(VariantTypeId::Boolean), Variant::Empty);
    assert_eq!(Variant::from(1f64).cast(VariantTypeId::Boolean), Variant::from(true));
...
fn variant_convert_float() {
    ...
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::Byte, VariantTypeId::ByteString,
        VariantTypeId::DateTime, VariantTypeId::ExpandedNodeId, VariantTypeId::Guid,
        VariantTypeId::Int16, VariantTypeId::Int32, VariantTypeId::Int64, VariantTypeId::NodeId,
        VariantTypeId::SByte, VariantTypeId::StatusCode, VariantTypeId::String, VariantTypeId::LocalizedText,
        VariantTypeId::QualifiedName, VariantTypeId::UInt16, VariantTypeId::UInt32, VariantTypeId::UInt64,
        VariantTypeId::XmlElement
    ]);
}
...
fn variant_cast_float() {
    let v: Variant = 12.5f32.into();
    // Boolean
    assert_eq!(Variant::from(11f32).cast(VariantTypeId::Boolean), Variant::Empty);
    assert_eq!(Variant::from(1f32).cast(VariantTypeId::Boolean), Variant::from(true));
    // Cast
    assert_eq!(v.cast(VariantTypeId::Byte), Variant::from(13u8));
    assert_eq!(v.cast(VariantTypeId::Int16), Variant::from(13i16));
    assert_eq!(v.cast(VariantTypeId::Int32), Variant::from(13i32));
...
fn variant_convert_int16() {
    ...
    // Impermissible
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::Byte, VariantTypeId::ByteString, VariantTypeId::DateTime,
        VariantTypeId::ExpandedNodeId, VariantTypeId::Guid, VariantTypeId::SByte, VariantTypeId::NodeId,
        VariantTypeId::StatusCode, VariantTypeId::String, VariantTypeId::LocalizedText, VariantTypeId::QualifiedName,
        VariantTypeId::UInt16, VariantTypeId::XmlElement
    ]);
}
...
fn variant_cast_int16() {
    ...
    assert_eq!(Variant::from(1i16).cast(VariantTypeId::Boolean), Variant::from(true));
    assert_eq!(v.cast(VariantTypeId::Byte), Variant::from(8u8));
    assert_eq!(Variant::from(-120i16).cast(VariantTypeId::Byte), Variant::Empty);
    assert_eq!(v.cast(VariantTypeId::SByte), Variant::from(8i8));
    assert_eq!(Variant::from(-137i16).cast(VariantTypeId::SByte), Variant::Empty);
...
fn variant_convert_int32() {
    ...
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::Byte, VariantTypeId::ByteString, VariantTypeId::DateTime,
        VariantTypeId::ExpandedNodeId, VariantTypeId::Guid, VariantTypeId::Int16, VariantTypeId::NodeId,
        VariantTypeId::SByte, VariantTypeId::StatusCode, VariantTypeId::String, VariantTypeId::LocalizedText,
        VariantTypeId::QualifiedName, VariantTypeId::UInt16, VariantTypeId::UInt32, VariantTypeId::XmlElement
    ]);
}
...
fn variant_cast_int32() {
    ...
    // Boolean
    assert_eq!(v.cast(VariantTypeId::Boolean), Variant::Empty);
    assert_eq!(Variant::from(1i32).cast(VariantTypeId::Boolean), Variant::from(true));
    // Byte
    assert_eq!(v.cast(VariantTypeId::Byte), Variant::from(9u8));
    assert_eq!(Variant::from(-120i32).cast(VariantTypeId::Byte), Variant::Empty);
    // Int16
    assert_eq!(v.cast(VariantTypeId::Int16), Variant::from(9i16));
    // SByte
    assert_eq!(v.cast(VariantTypeId::SByte), Variant::from(9i8));
    assert_eq!(Variant::from(-137i32).cast(VariantTypeId::SByte), Variant::Empty);
    // StatusCode
    let status_code = StatusCode::BadResourceUnavailable | StatusCode::HISTORICAL_RAW | StatusCode::SEMANTICS_CHANGED;
    assert_eq!(Variant::from(status_code.bits() as i32).cast(VariantTypeId::StatusCode), Variant::from(status_code));
    // String
    assert_eq!(v.cast(VariantTypeId::String), Variant::from("9"));
    // UInt16
    assert_eq!(v.cast(VariantTypeId::UInt16), Variant::from(9u16));
    assert_eq!(Variant::from(-120i32).cast(VariantTypeId::UInt16), Variant::Empty);
    // UInt32
    assert_eq!(v.cast(VariantTypeId::UInt32), Variant::from(9u32));
    assert_eq!(Variant::from(-120i32).cast(VariantTypeId::UInt32), Variant::Empty);
}
...
fn variant_convert_int64() {
    ...
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::Byte, VariantTypeId::ByteString, VariantTypeId::DateTime,
        VariantTypeId::ExpandedNodeId, VariantTypeId::Guid, VariantTypeId::Int16, VariantTypeId::Int32,
        VariantTypeId::NodeId, VariantTypeId::SByte, VariantTypeId::StatusCode, VariantTypeId::String,
        VariantTypeId::LocalizedText, VariantTypeId::QualifiedName, VariantTypeId::UInt16, VariantTypeId::UInt32,
        VariantTypeId::UInt64, VariantTypeId::XmlElement,
    ]);
}
...
fn variant_cast_int64() {
    ...
    // Boolean
    assert_eq!(v.cast(VariantTypeId::Boolean), Variant::Empty);
    assert_eq!(Variant::from(1i64).cast(VariantTypeId::Boolean), Variant::from(true));
    // Byte
    assert_eq!(v.cast(VariantTypeId::Byte), Variant::from(10u8));
    assert_eq!(Variant::from(-120i64).cast(VariantTypeId::Byte), Variant::Empty);
    // Int16
    assert_eq!(v.cast(VariantTypeId::Int16), Variant::from(10i16));
    // SByte
    assert_eq!(v.cast(VariantTypeId::SByte), Variant::from(10i8));
    assert_eq!(Variant::from(-137i64).cast(VariantTypeId::SByte), Variant::Empty);
    // StatusCode
    let status_code = StatusCode::BadResourceUnavailable | StatusCode::HISTORICAL_RAW | StatusCode::SEMANTICS_CHANGED;
    assert_eq!(Variant::from(status_code.bits() as i64).cast(VariantTypeId::StatusCode), Variant::from(status_code));
    // String
    assert_eq!(v.cast(VariantTypeId::String), Variant::from("10"));
    // UInt16
    assert_eq!(v.cast(VariantTypeId::UInt16), Variant::from(10u16));
    assert_eq!(Variant::from(-120i64).cast(VariantTypeId::UInt16), Variant::Empty);
    // UInt32
    assert_eq!(v.cast(VariantTypeId::UInt32), Variant::from(10u32));
    assert_eq!(Variant::from(-120i64).cast(VariantTypeId::UInt32), Variant::Empty);
    // UInt64
...
fn variant_convert_sbyte() {
    ...
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::Byte, VariantTypeId::ByteString, VariantTypeId::DateTime,
        VariantTypeId::ExpandedNodeId, VariantTypeId::Guid, VariantTypeId::NodeId, VariantTypeId::StatusCode,
        VariantTypeId::String, VariantTypeId::LocalizedText, VariantTypeId::QualifiedName,
        VariantTypeId::XmlElement
    ]);
}
...
fn variant_cast_sbyte() {
    ...
    // Boolean
    assert_eq!(v.cast(VariantTypeId::Boolean), Variant::Empty);
    assert_eq!(Variant::from(1i8).cast(VariantTypeId::Boolean), Variant::from(true));
    // Byte
    assert_eq!(v.cast(VariantTypeId::Byte), Variant::from(12u8));
    assert_eq!(Variant::from(-120i8).cast(VariantTypeId::Byte), Variant::Empty);
    // String
...
fn variant_convert_string() {
    ...
    assert_eq!(v.convert(v.type_id()), v);
    // Boolean
    assert_eq!(Variant::from("1").convert(VariantTypeId::Boolean), true.into());
    assert_eq!(Variant::from("0").convert(VariantTypeId::Boolean), false.into());
    assert_eq!(Variant::from("true").convert(VariantTypeId::Boolean), true.into());
    assert_eq!(Variant::from("false").convert(VariantTypeId::Boolean), false.into());
    assert_eq!(Variant::from(" false").convert(VariantTypeId::Boolean), Variant::Empty);
    // Byte
    assert_eq!(Variant::from("12").convert(VariantTypeId::Byte), 12u8.into());
    assert_eq!(Variant::from("256").convert(VariantTypeId::Byte), Variant::Empty);
    // Double
    assert_eq!(Variant::from("12.5").convert(VariantTypeId::Double), 12.5f64.into());
    // Float
    assert_eq!(Variant::from("12.5").convert(VariantTypeId::Float), 12.5f32.into());
    // Guid
    assert_eq!(Variant::from("d47a32c9-5ee7-43c1-a733-0fe30bf26b50").convert(VariantTypeId::Guid), Guid::from_str("d47a32c9-5ee7-43c1-a733-0fe30bf26b50").unwrap().into());
    // Int16
    assert_eq!(Variant::from("12").convert(VariantTypeId::Int16), 12i16.into());
    assert_eq!(Variant::from("65536").convert(VariantTypeId::Int16), Variant::Empty);
    // Int32
    assert_eq!(Variant::from("12").convert(VariantTypeId::Int32), 12i32.into());
    assert_eq!(Variant::from("2147483648").convert(VariantTypeId::Int32), Variant::Empty);
    // Int64
    assert_eq!(Variant::from("12").convert(VariantTypeId::Int64), 12i64.into());
    assert_eq!(Variant::from("9223372036854775808").convert(VariantTypeId::Int64), Variant::Empty);
    // SByte
    assert_eq!(Variant::from("12").convert(VariantTypeId::SByte), 12i8.into());
    assert_eq!(Variant::from("128").convert(VariantTypeId::SByte), Variant::Empty);
    assert_eq!(Variant::from("-129").convert(VariantTypeId::SByte), Variant::Empty);
    // UInt16
    assert_eq!(Variant::from("12").convert(VariantTypeId::UInt16), 12u16.into());
    assert_eq!(Variant::from("65536").convert(VariantTypeId::UInt16), Variant::Empty);
    // UInt32
    assert_eq!(Variant::from("12").convert(VariantTypeId::UInt32), 12u32.into());
    assert_eq!(Variant::from("4294967296").convert(VariantTypeId::UInt32), Variant::Empty);
    // UInt64
    assert_eq!(Variant::from("12").convert(VariantTypeId::UInt64), 12u64.into());
    assert_eq!(Variant::from("18446744073709551615").convert(VariantTypeId::UInt32), Variant::Empty);
    // Impermissible
    let v = Variant::from("xxx");
    ensure_conversion_fails(&v, &[
        VariantTypeId::ByteString, VariantTypeId::StatusCode, VariantTypeId::XmlElement
    ]);
}
...
fn variant_cast_string() {
    ...
    // ExpandedNodeId
    assert_eq!(Variant::from("svr=5;ns=22;s=Hello World").cast(VariantTypeId::ExpandedNodeId), ExpandedNodeId {
        node_id: NodeId::new(22, "Hello World"),
        namespace_uri: UAString::null(),
        server_index: 5,
    }.into());
    // NodeId
    assert_eq!(Variant::from("ns=22;s=Hello World").cast(VariantTypeId::NodeId), NodeId::new(22, "Hello World").into());
    // LocalizedText
    assert_eq!(Variant::from("Localized Text").cast(VariantTypeId::LocalizedText), LocalizedText::new("", "Localized Text").into());
    // QualifiedName
    assert_eq!(Variant::from("Qualified Name").cast(VariantTypeId::QualifiedName), QualifiedName::new(0, "Qualified Name").into());
}
...
fn variant_convert_uint16() {
    ...
    assert_eq!(v.convert(VariantTypeId::StatusCode), Variant::StatusCode(StatusCode::from_bits_truncate(80 << 16)));
    assert_eq!(v.convert(VariantTypeId::UInt32), Variant::UInt32(80));
    assert_eq!(v.convert(VariantTypeId::UInt64), Variant::UInt64(80));
    // Impermissible
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::Byte, VariantTypeId::ByteString, VariantTypeId::DateTime,
        VariantTypeId::ExpandedNodeId, VariantTypeId::Guid, VariantTypeId::SByte, VariantTypeId::String,
        VariantTypeId::NodeId, VariantTypeId::LocalizedText, VariantTypeId::QualifiedName,
        VariantTypeId::XmlElement,
    ]);
}
...
fn variant_cast_uint16() {
    ...
    // Boolean
    assert_eq!(v.cast(VariantTypeId::Boolean), Variant::Empty);
    assert_eq!(Variant::from(1u16).cast(VariantTypeId::Boolean), Variant::from(true));
    // Byte
    assert_eq!(v.cast(VariantTypeId::Byte), Variant::from(80u8));
    assert_eq!(Variant::from(256u16).cast(VariantTypeId::Byte), Variant::Empty);
    // SByte
    assert_eq!(v.cast(VariantTypeId::SByte), Variant::from(80i8));
    assert_eq!(Variant::from(128u16).cast(VariantTypeId::SByte), Variant::Empty);
    // String
...
fn variant_convert_uint32() {
    ...
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::Byte, VariantTypeId::ByteString, VariantTypeId::DateTime,
        VariantTypeId::ExpandedNodeId, VariantTypeId::Guid, VariantTypeId::Int16, VariantTypeId::SByte,
        VariantTypeId::StatusCode, VariantTypeId::String, VariantTypeId::NodeId, VariantTypeId::LocalizedText,
        VariantTypeId::QualifiedName, VariantTypeId::UInt16, VariantTypeId::XmlElement
    ]);
}
...
fn variant_cast_uint32() {
    ...
    // Boolean
    assert_eq!(v.cast(VariantTypeId::Boolean), Variant::Empty);
    assert_eq!(Variant::from(1u32).cast(VariantTypeId::Boolean), Variant::from(true));
    // Byte
    assert_eq!(v.cast(VariantTypeId::Byte), Variant::from(23u8));
    assert_eq!(Variant::from(256u32).cast(VariantTypeId::Byte), Variant::Empty);
    // Int16
    assert_eq!(v.cast(VariantTypeId::Int16), Variant::from(23i16));
    assert_eq!(Variant::from(102256u32).cast(VariantTypeId::Int16), Variant::Empty);
    // SByte
    assert_eq!(v.cast(VariantTypeId::SByte), Variant::from(23i8));
    assert_eq!(Variant::from(128u32).cast(VariantTypeId::SByte), Variant::Empty);
    // StatusCode
    let status_code = StatusCode::BadResourceUnavailable | StatusCode::HISTORICAL_RAW | StatusCode::SEMANTICS_CHANGED;
    assert_eq!(Variant::from(status_code.bits() as u32).cast(VariantTypeId::StatusCode), Variant::from(status_code));
    // String
    assert_eq!(v.cast(VariantTypeId::String), Variant::from("23"));
    // UInt16
    assert_eq!(v.cast(VariantTypeId::UInt16), Variant::from(23u16));
    assert_eq!(Variant::from(102256u32).cast(VariantTypeId::UInt16), Variant::Empty);
}
...
fn variant_convert_uint64() {
    ...
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::Byte, VariantTypeId::ByteString, VariantTypeId::DateTime,
        VariantTypeId::ExpandedNodeId, VariantTypeId::Guid, VariantTypeId::Int16, VariantTypeId::Int32,
        VariantTypeId::SByte, VariantTypeId::StatusCode, VariantTypeId::String, VariantTypeId::NodeId,
        VariantTypeId::LocalizedText, VariantTypeId::QualifiedName, VariantTypeId::UInt16, VariantTypeId::UInt32,
        VariantTypeId::XmlElement,
    ]);
}
...
fn variant_cast_uint64() {
    ...
    // Boolean
    assert_eq!(v.cast(VariantTypeId::Boolean), Variant::Empty);
    assert_eq!(Variant::from(1u64).cast(VariantTypeId::Boolean), Variant::from(true));
    // Byte
    assert_eq!(v.cast(VariantTypeId::Byte), Variant::from(43u8));
    assert_eq!(Variant::from(256u64).cast(VariantTypeId::Byte), Variant::Empty);
    // Int16
    assert_eq!(v.cast(VariantTypeId::Int16), Variant::from(43i16));
    assert_eq!(Variant::from(102256u64).cast(VariantTypeId::Int16), Variant::Empty);
    // SByte
    assert_eq!(v.cast(VariantTypeId::SByte), Variant::from(43i8));
    assert_eq!(Variant::from(128u64).cast(VariantTypeId::SByte), Variant::Empty);
    // StatusCode
    let status_code = StatusCode::BadResourceUnavailable | StatusCode::HISTORICAL_RAW | StatusCode::SEMANTICS_CHANGED;
    assert_eq!(Variant::from(status_code.bits() as u64).cast(VariantTypeId::StatusCode), Variant::from(status_code));
    // String
    assert_eq!(v.cast(VariantTypeId::String), Variant::from("43"));
    // UInt16
    assert_eq!(v.cast(VariantTypeId::UInt16), Variant::from(43u16));
    assert_eq!(Variant::from(102256u64).cast(VariantTypeId::UInt16), Variant::Empty);
    // UInt32
    assert_eq!(v.cast(VariantTypeId::UInt32), Variant::from(43u32));
    assert_eq!(Variant::from(4294967298u64).cast(VariantTypeId::UInt32), Variant::Empty);
}
...
fn variant_convert_guid() {
    ...
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::Byte, VariantTypeId::ByteString, VariantTypeId::DateTime,
        VariantTypeId::Double, VariantTypeId::ExpandedNodeId, VariantTypeId::Float,
        VariantTypeId::Int16, VariantTypeId::Int32, VariantTypeId::Int64, VariantTypeId::NodeId,
        VariantTypeId::SByte, VariantTypeId::StatusCode, VariantTypeId::String,
        VariantTypeId::LocalizedText, VariantTypeId::QualifiedName, VariantTypeId::UInt16, VariantTypeId::UInt32,
        VariantTypeId::UInt64, VariantTypeId::XmlElement,
    ]);
}
...
fn variant_convert_status_code() {
    ...
    assert_eq!(v.convert(VariantTypeId::Int32), Variant::Int32(-2136276992i32)); // 0x80AB_0000 overflows to negative
    assert_eq!(v.convert(VariantTypeId::Int64), Variant::Int64(0x80AB_0000));
    assert_eq!(v.convert(VariantTypeId::UInt32), Variant::UInt32(0x80AB_0000));
    assert_eq!(v.convert(VariantTypeId::UInt64), Variant::UInt64(0x80AB_0000));
    // Impermissible
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::Byte, VariantTypeId::ByteString, VariantTypeId::DateTime,
        VariantTypeId::Double, VariantTypeId::ExpandedNodeId, VariantTypeId::Float, VariantTypeId::Guid,
        VariantTypeId::Int16, VariantTypeId::NodeId, VariantTypeId::SByte, VariantTypeId::String,
        VariantTypeId::LocalizedText, VariantTypeId::QualifiedName, VariantTypeId::UInt16,
        VariantTypeId::XmlElement,
    ]);
}
...
fn variant_convert_byte_string() {
    ...
    // Impermissible
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::Byte, VariantTypeId::DateTime, VariantTypeId::Double,
        VariantTypeId::ExpandedNodeId, VariantTypeId::Float, VariantTypeId::Guid,
        VariantTypeId::Int16, VariantTypeId::Int32, VariantTypeId::Int64, VariantTypeId::NodeId,
        VariantTypeId::SByte, VariantTypeId::StatusCode, VariantTypeId::String,
        VariantTypeId::LocalizedText, VariantTypeId::QualifiedName, VariantTypeId::UInt16, VariantTypeId::UInt32,
        VariantTypeId::UInt64, VariantTypeId::XmlElement,
...
fn variant_convert_qualified_name() {
    ...
    assert_eq!(v.convert(v.type_id()), v);
    // LocalizedText
    assert_eq!(v.convert(VariantTypeId::LocalizedText), Variant::from(LocalizedText::new("", "hello")));
    // String
    ...
    ensure_conversion_fails(&v, &[
        ...
        VariantTypeId::Double, VariantTypeId::ExpandedNodeId, VariantTypeId::Float, VariantTypeId::Guid,
        VariantTypeId::Int16, VariantTypeId::Int32, VariantTypeId::Int64, VariantTypeId::NodeId,
        VariantTypeId::SByte, VariantTypeId::StatusCode, VariantTypeId::UInt16, VariantTypeId::UInt32,
        VariantTypeId::UInt64, VariantTypeId::XmlElement,
    ]);
}
...
fn variant_convert_localized_text() {
    ...
    ensure_conversion_fails(&v, &[
        ...
        VariantTypeId::Double, VariantTypeId::ExpandedNodeId, VariantTypeId::Float, VariantTypeId::Guid,
        VariantTypeId::Int16, VariantTypeId::Int32, VariantTypeId::Int64, VariantTypeId::NodeId,
        VariantTypeId::SByte, VariantTypeId::StatusCode, VariantTypeId::QualifiedName,
        VariantTypeId::UInt16, VariantTypeId::UInt32, VariantTypeId::UInt64, VariantTypeId::XmlElement,
    ]);
}
...
fn variant_convert_node_id() {
    ...
    assert_eq!(v.convert(v.type_id()), v);
    // ExpandedNodeId
    assert_eq!(v.convert(VariantTypeId::ExpandedNodeId), Variant::from(ExpandedNodeId {
        node_id: NodeId::new(99, "my node"),
        namespace_uri: UAString::null(),
        server_index: 0,
    }));
    // String
    assert_eq!(v.convert(VariantTypeId::String), Variant::from("ns=99;s=my node"));
    // Impermissible
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::Byte, VariantTypeId::ByteString, VariantTypeId::DateTime,
        VariantTypeId::Double, VariantTypeId::Float, VariantTypeId::Guid, VariantTypeId::Int16, VariantTypeId::Int32,
        VariantTypeId::Int64, VariantTypeId::SByte, VariantTypeId::LocalizedText,
        VariantTypeId::QualifiedName, VariantTypeId::UInt16, VariantTypeId::UInt32,
        VariantTypeId::UInt64, VariantTypeId::XmlElement,
    ]);
}
...
fn variant_convert_expanded_node_id() {
    ...
    assert_eq!(v.convert(v.type_id()), v);
    // String
    assert_eq!(v.convert(VariantTypeId::String), Variant::from("svr=5;ns=22;s=Hello World"));
    // Impermissible
    ensure_conversion_fails(&v, &[
        VariantTypeId::Boolean, VariantTypeId::Byte, VariantTypeId::ByteString, VariantTypeId::DateTime,
        VariantTypeId::Double, VariantTypeId::Float, VariantTypeId::Guid, VariantTypeId::Int16, VariantTypeId::Int32,
        VariantTypeId::Int64, VariantTypeId::NodeId, VariantTypeId::SByte, VariantTypeId::LocalizedText,
        VariantTypeId::QualifiedName, VariantTypeId::UInt16, VariantTypeId::UInt32,
        VariantTypeId::UInt64, VariantTypeId::XmlElement,
    ]);
}
