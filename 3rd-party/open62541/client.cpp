...
static void handler_valueChanged(UA_Client *client,
                                 UA_UInt32 subId,
                                 void *subContext,
                                 UA_UInt32 monId,
                                 void *monContext,
...
int main(void)
{
    ...
    while (running)
    {
        ...
        if (retval != UA_STATUSCODE_GOOD)
        {
            ...
            /* The connect may timeout after 5 seconds (default timeout) or it may fail immediately
             * on network errors */
            /* E.g. name resolution errors or unreachable network. Thus there should be a small
             * sleep here */
            UA_sleep_ms(1000);
            continue;
        }
