...
impl BinaryEncoder<SessionDiagnosticsDataType> for SessionDiagnosticsDataType {
    ...
    fn decode<S: Read>(stream: &mut S) -> EncodingResult<Self> {
        ...
        Ok(SessionDiagnosticsDataType {
            ...
            actual_session_timeout: actual_session_timeout,
            max_response_message_size: max_response_message_size,
            client_connection_time: client_connection_time,
            client_last_contact_time: client_last_contact_time,
            current_subscriptions_count: current_subscriptions_count,
            current_monitored_items_count: current_monitored_items_count,
            current_publish_requests_in_queue: current_publish_requests_in_queue,
            ...
            create_monitored_items_count: create_monitored_items_count,
            modify_monitored_items_count: modify_monitored_items_count,
            set_monitoring_mode_count: set_monitoring_mode_count,
            set_triggering_count: set_triggering_count,
            delete_monitored_items_count: delete_monitored_items_count,
            create_subscription_count: create_subscription_count,
            modify_subscription_count: modify_subscription_count,
            set_publishing_mode_count: set_publishing_mode_count,
            publish_count: publish_count,
            republish_count: republish_count,
            transfer_subscriptions_count: transfer_subscriptions_count,
            delete_subscriptions_count: delete_subscriptions_count,
            add_nodes_count: add_nodes_count,
            add_references_count: add_references_count,
            delete_nodes_count: delete_nodes_count,
            delete_references_count: delete_references_count,
            browse_count: browse_count,
            browse_next_count: browse_next_count,
            translate_browse_paths_to_node_ids_count: translate_browse_paths_to_node_ids_count,
            query_first_count: query_first_count,
            query_next_count: query_next_count,
            register_nodes_count: register_nodes_count,
            unregister_nodes_count: unregister_nodes_count,
        })
    }
}
