...
//   in the populate_address_space method add nodes
  ...
  settings.write_to_file(`${settings.rs_address_space_dir}/generated/${ns.module}.rs`, contents);
});
...
mod_contents += `}\n`;
settings.write_to_file(`${settings.rs_address_space_dir}/generated/mod.rs`, mod_contents);
